...
// Adjust 'initText' as necessary, but the logic for generating the text effect remains the same.
function initText() {
	var i = textIndex;
	...
	function update() {
		...
		// supprise happy birthday!
		if (supprise && onHold == 10) {
			supprise = false;
			setTimeout(initText, 2000);
		}
